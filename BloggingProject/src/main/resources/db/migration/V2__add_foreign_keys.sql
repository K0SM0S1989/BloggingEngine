...
alter table tags2posts add constraint FKtranpyif8bkvolnad0po1yjfa foreign key (post_id) references posts (id);
alter table tags2posts add constraint FK7iegdu0y5fg48fn6ndb9bu5vk foreign key (tag_id) references tags (id);